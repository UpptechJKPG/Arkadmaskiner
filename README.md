...
För att ändra till X11, skriv `sudo raspi-config` i terminalen och tryck Enter, då får du upp en meny. Välj "6 Advanced Options", sedan "A6 Wayland" och till sist "W1 X11". \
